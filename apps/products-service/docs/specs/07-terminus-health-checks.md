...
- `GET http://localhost:4004/health` deve retornar HTTP 200 com body contendo `status`, `info`, `error` e `details`.
...
| `products-service/src/domain/health/health.controller.ts` | Reescrever — usar terminus |
| `products-service/src/domain/health/health.module.ts` | Criar |
