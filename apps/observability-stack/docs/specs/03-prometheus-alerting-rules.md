...
Configurar **alerting rules** no Prometheus para detectar proativamente problemas de infraestrutura e negócio no marketplace, e adicionar um **painel de alertas ativos** ao dashboard "Marketplace Overview" do Grafana.
...
# Acessar http://localhost:4000 → Dashboard "Marketplace Overview"
