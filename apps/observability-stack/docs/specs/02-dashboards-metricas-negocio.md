...
Adicionar **métricas de negócio customizadas** aos serviços `payments-service` e `checkout-service`, e criar **dois dashboards provisionados** no Grafana para visibilidade operacional e de negócio do marketplace.
