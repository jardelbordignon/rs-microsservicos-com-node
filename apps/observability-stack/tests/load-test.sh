...
check_service "http://localhost:4005/health" "Users Service"
check_service "http://localhost:4004/health" "Products Service"
check_service "http://localhost:4003/health" "Payments Service"
check_service "http://localhost:4002/health" "Checkout Service"
check_service "$PROM/-/healthy" "Prometheus"
check_service "http://localhost:4000/api/health" "Grafana"
...
echo ""
echo "    cd <PROJE_ROOT>/apps/products-service && npm run start:dev"
echo ""
log "Após reiniciar, os alertas ServiceDown devem resolver em ~1 minuto."
echo ""

header "TESTE CONCLUÍDO"
log "Abra o Grafana em http://localhost:4000 (admin/admin)"
